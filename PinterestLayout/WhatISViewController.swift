...
class WhatISViewController: UIViewController, UIPageViewControllerDataSource {

    var pageViewController : UIPageViewController?
    var pageTitles : Array<String> = ["", "", ""]
    var pageImages : Array<String> = ["slide3.jpg", "slide47.jpg", "homeworth.png"]
    ...
    override func viewDidLoad()
    {
        ...
        self.title = "What Is My Home Worth?"
