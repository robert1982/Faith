//
//  NegotitingViewController.swift
//  Listing Pro
//
...
class NegotitingViewController: UIViewController, UIPageViewControllerDataSource
{
    var pageViewController : UIPageViewController?
    var pageTitles : Array<String> = ["", ""]
    var pageImages : Array<String> = ["slide9.jpg", "slide362.jpg"]
    ...
    override func viewDidLoad()
    {
        ...
        self.title = "Negotiating With Qualified Buyers"
