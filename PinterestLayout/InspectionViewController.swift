...
class InspectionViewController: UIViewController, UIPageViewControllerDataSource
{
    var pageViewController : UIPageViewController?
    var pageTitles : Array<String> = ["", "", "", ""]
    var pageImages : Array<String> = ["slide5.jpg", "agnewtermite1.jpg", "agnewtermite2.jpg", "inspection.jpg"]
